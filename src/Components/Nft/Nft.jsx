...
function Nft() {
  return (
    <div>
        <section class="tf-box-icon live-auctions style1 nft_bg tf-section no-pt-mb">
                        ...
                        <div class="col-md-12">
                            <div class="sc-box-icon-inner style2">
                                <div class="sc-box-icon box1">
                                    ...
                                    <p class="content">Set up and connect Metamask wallet for purchasing NFTs. Other wallet connectivity coming soon</p>
                                </div>
                                <div class="sc-box-icon box1">
                                    <div class="image">
                                        <svg width="60" height="60" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg">
