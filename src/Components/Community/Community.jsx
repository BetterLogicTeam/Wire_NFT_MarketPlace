...
<section class="flat-title-page inner activepage_bg">
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="page-title-heading mg-bt-12">
                <h1 class="heading text-center">Community </h1>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="tf-section sc-card-blog dark-style2">
                <div class="themesflat-container">
                    <div class="row">
                        <div class="fl-blog fl-item2 col-lg-4 col-md-6" style={{display: "block"}}>
                            <article class="sc-card-article">
                                <div class="card-media">
                                    <a href="#"><img src="images/blog/thumb-1.jpg" alt=""/></a>
                                </div>
                                <div class="meta-info">
                                    <div class="author">
                                        <div class="avatar">
                                ...
                                <div class="text-article">
                                    <h3><a href="#">The next big trend in crypto</a></h3>
                                ...
                                <a href="#" class="sc-button fl-button pri-3"><span>Read More</span></a> 
                            </article>
                        </div>
                        <div class="fl-blog fl-item2 col-lg-4 col-md-6" style={{display: "block"}}>
                            <article class="sc-card-article">
                                <div class="card-media">
                                    <a href="#"><img src="images/blog/thumg-3-1.jpg" alt=""/></a>
                                </div>
                                <div class="meta-info">
                                    <div class="author">
                                        <div class="avatar">
                        ...
                        <div class="fl-blog fl-item2 col-lg-4 col-md-6" style={{display: "block"}}>
                            <article class="sc-card-article">
                                <div class="card-media">
                                    <a href="#"><img src="images/blog/thumb-4.jpg" alt=""/></a>
                                </div>
                                <div class="meta-info">
                                    <div class="author">
                                        <div class="avatar">
                        ...
                        <div class="fl-blog fl-item2 col-lg-4 col-md-6" style={{display: "block"}}>
                            <article class="sc-card-article">
                                <div class="card-media">
                                    <a href="#"><img src="images/blog/thumb-2.jpg" alt=""/></a>
                                </div>
                                <div class="meta-info">
                                    <div class="author">
                                        <div class="avatar">
                        ...
                        <div class="fl-blog fl-item2 col-lg-4 col-md-6" style={{display: "block"}}>
                            <article class="sc-card-article">
                                <div class="card-media">
                                    <a href="#"><img src="images/blog/thumb-5.jpg" alt=""/></a>
                                </div>
                                <div class="meta-info">
                                    <div class="author">
                                        <div class="avatar">
                                            <img src="images/avatar/avt-8.jpg" alt=""/>
                                        </div>
                                        <div class="info">
                                            <span>Post owner</span>
                                            <h6> <a href="author02.html">Tyler Covington</a> </h6>
                        ...
                        <div class="fl-blog fl-item2 col-lg-4 col-md-6" style={{display: "block"}}>
                            <article class="sc-card-article">
                                <div class="card-media">
                                    <a href="#"><img src="images/blog/thumb-6-1.jpg" alt=""/></a>
                                </div>
                                <div class="meta-info">
                                    <div class="author">
                                        <div class="avatar">
